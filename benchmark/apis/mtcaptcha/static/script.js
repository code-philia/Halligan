...
class Captcha {
    ...
    constructor(id, image, length) {
        ...
        const challenge = document.querySelector("#mtcap-image-1");
        challenge.style["backgroundImage"] = `url(data:image/png;base64,${image})`;

        const input = document.querySelector("#mtcap-inputtext-1");
