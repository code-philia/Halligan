...
def init(id: str):
    return render_template('yandex_text/index.html', id=id)


@text.route('/challenge/<id>', methods=["GET"])
...
@text.route("/submit", methods=["POST"])
def submit_challenge():
    ...
    solved = True if labels[0].lower() == state.replace(" ", "").lower() else False
